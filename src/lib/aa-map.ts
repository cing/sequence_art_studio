...
function physicochemicalMap(): ResidueStyleMap {
  return fromAssignments({
    // Conventional MSA-like chemistry palette:
    // acidic (D/E) red, basic (K/R/H) blue.
    A: { color: '#4daf4a', shape: 'circle' },
    V: { color: '#4daf4a', shape: 'circle' },
    L: { color: '#4daf4a', shape: 'circle' },
    I: { color: '#4daf4a', shape: 'circle' },
    M: { color: '#4daf4a', shape: 'circle' },
    F: { color: '#984ea3', shape: 'diamond' },
    W: { color: '#984ea3', shape: 'diamond' },
    Y: { color: '#984ea3', shape: 'diamond' },
    S: { color: '#45b6c9', shape: 'square' },
    T: { color: '#45b6c9', shape: 'square' },
    N: { color: '#45b6c9', shape: 'square' },
    Q: { color: '#45b6c9', shape: 'square' },
    K: { color: '#377eb8', shape: 'triangle' },
    R: { color: '#377eb8', shape: 'triangle' },
    H: { color: '#377eb8', shape: 'triangle' },
    D: { color: '#e41a1c', shape: 'hex' },
    E: { color: '#e41a1c', shape: 'hex' },
    C: { color: '#ffd92f', shape: 'ring' },
    G: { color: '#ff7f00', shape: 'hex' },
    P: { color: '#ff7f00', shape: 'ring' },
    U: { color: '#ffd92f', shape: 'ring' },
    O: { color: '#377eb8', shape: 'triangle' },
